...
public class TempScheduleRowMapper implements RowMapper<TempSchedule> {

	@Override
	public TempSchedule mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		TempSchedule result = new TempSchedule();
